...
export async function POST(
  ...
  if (slug == "create-account") {
    try {
      if (requestBody.type == "companyAccountId") {
      ...
      } else if (requestBody.type == "individualAccountId") {
        // See information you can prefill at https://docs.stripe.com/api/accounts/create.
        const account = await stripe.accounts.create({
          type: "custom",
          country: "US",
        ...
        accountId = account.id;
      } else if (requestBody.type == "maxAccountId") {
        // See information you can prefill at https://docs.stripe.com/api/accounts/create.
        const account = await stripe.accounts.create({
          type: "custom",
          business_type: "company",
      ...
      } else if (requestBody.type == "minAccountId") {
        // See information you can prefill at https://docs.stripe.com/api/accounts/create.
        const account = await stripe.accounts.create({
          type: "custom",
          country: "US",
